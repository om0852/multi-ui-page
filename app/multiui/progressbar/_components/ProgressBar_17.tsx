...
type GlowingGradientProgressBarProps = {
...
const GlowingGradientProgressBar: React.FC<GlowingGradientProgressBarProps> = ({
  progress,
  height = "h-4",
  color = "bg-blue-500",
...
export default GlowingGradientProgressBar;
