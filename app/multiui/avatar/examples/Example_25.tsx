...
import Avatar from '../_components/Avatar_25';

export default function AvatarExample25() {
  const avatarImages = [
  ...
  return (
    <div className="p-4 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      <h2 className="text-2xl font-bold text-white mb-6">3D Tilt Avatar</h2>
      ...
      <div className="flex flex-col space-y-8 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col space-y-4">
          <h3 className="text-xl font-semibold text-white text-center">Move your mouse over the avatar to see the 3D tilt effect</h3>
          ...
          <p className="text-white text-center mt-4">
            The avatar tilts in 3D space following your mouse movement, with dynamic shadows and a subtle gradient overlay
          </p>
        </div>
      </div>
    </div>
