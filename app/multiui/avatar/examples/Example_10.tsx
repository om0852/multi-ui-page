...
import Avatar from '../_components/Avatar_10';

export default function AvatarExample10() {
  const avatarImages = [
  ...
  return (
    <div className="p-4 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      <h2 className="text-2xl font-bold text-white mb-6">Pulse Border Avatar</h2>
      ...
      <div className="flex flex-col space-y-8 max-w-2xl mx-auto">
        ...
        {/* Hover instructions */}
        <div className="flex flex-col space-y-4">
          <h3 className="text-xl font-semibold text-white text-center">Hover over avatars to see the scale effect</h3>
          ...
          <p className="text-white text-center mt-4">
            The avatar features a pulsing gradient border and scales up on hover
          </p>
        </div>
      </div>
    </div>
