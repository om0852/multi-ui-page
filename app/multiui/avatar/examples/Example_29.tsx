...
import Avatar from '../_components/Avatar_29';

export default function AvatarExample29() {
  const avatarImages = [
  ...
  return (
    <div className="p-4 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      <h2 className="text-2xl font-bold text-white mb-6">Magnetic Particles Avatar</h2>
      ...
      <div className="flex flex-col space-y-8 max-w-2xl mx-auto">
        ...
        {/* Hover instructions */}
        <div className="flex flex-col space-y-4">
          <h3 className="text-xl font-semibold text-white text-center">Hover over avatars to see the magnetic effect</h3>
          ...
          <p className="text-white text-center mt-4">
            Blue particles orbit around the avatar and get magnetically attracted toward the center on hover
          </p>
        </div>
      </div>
    </div>
