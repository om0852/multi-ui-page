...
import Avatar from '../_components/Avatar_14';

export default function AvatarExample14() {
  const avatarImages = [
  ...
  return (
    <div className="p-4 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      <h2 className="text-2xl font-bold text-white mb-6">Pulse Avatar</h2>
      ...
      <div className="flex flex-col space-y-8 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <p className="text-white text-center mt-4">
            The avatar continuously pulses with a scaling animation
          </p>
        </div>
      </div>
    </div>
