  ...
  return (
    <motion.button
      ...
      className={clsx(
        ...
        "shadow-[4px_4px_0_0_rgba(148,163,184,1)]",
        "hover:shadow-[2px_2px_0_0_rgba(148,163,184,1)]",
        "hover:translate-x-[2px] hover:translate-y-[2px]",
        "transition-all duration-200",
        "after:absolute after:inset-0",
        "after:bg-[linear-gradient(45deg,transparent,rgba(148,163,184,0.1),transparent)]",
    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <div className="fixed inset-0 z-50">
          ...
          >
            <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent,rgba(148,163,184,0.05),transparent)]" />
