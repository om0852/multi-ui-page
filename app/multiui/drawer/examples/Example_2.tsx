        ...
        <Drawer>
          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-gray-100 dark:bg-gray-800 shadow-[inset_-2px_-2px_6px_rgba(255,255,255,0.7),inset_2px_2px_6px_rgba(0,0,0,0.1)] dark:shadow-[inset_-2px_-2px_6px_rgba(255,255,255,0.1),inset_2px_2px_6px_rgba(0,0,0,0.3)]">
