...
const Button: React.FC<ButtonProps> = ({
  ...
  const glowingStyles = 'hover:shadow-lg hover:shadow-blue-500/50 focus:shadow-lg focus:shadow-blue-500/50';
  ...
  return (
    ...
    >
      <Component
        className={clsx(baseStyles, filledStyles, secondaryStyles, glowingStyles)}
        onClick={onClick}
      >
        <motion.span
