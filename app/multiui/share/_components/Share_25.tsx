      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={handleCopy}
            className="ml-3 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded-lg"
          >
            {copied ? "Copied!" : "Copy"}
          </motion.button>
        </div>
...
export function Component() {
  return (
    <div className="p-4">
      <Share_25 url="https://example.com/share-this" />
    </div>
  );
} 