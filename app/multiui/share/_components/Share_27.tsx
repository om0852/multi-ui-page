  ...
  return (
    <div className={className}>
      <motion.button
        ...
        className="px-4 py-2 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-lg flex items-center gap-2"
      >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-0 bottom-0 bg-white dark:bg-gray-800 rounded-t-3xl p-6 z-50"
            >
              ...
              <div className="grid grid-cols-4 gap-4">
                {platforms.map((platform, index) => (
                  <motion.button
                    ...
                    className={`flex flex-col items-center gap-2 p-4 ${platform.color} rounded-xl text-white`}
                  >
              ...
              <div className="mt-6">
                <div className="flex items-center gap-2 p-3 bg-gray-100 dark:bg-gray-700/50 rounded-xl">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={handleCopy}
                    className="px-3 py-1 text-sm font-medium text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-900/20 rounded-lg"
                  >
                    {copied ? "Copied!" : "Copy"}
                  </motion.button>
                </div>
...
export function Component() {
  return (
    <div className="p-4">
      <Share_27 url="https://example.com/share-this" />
    </div>
  );
} 