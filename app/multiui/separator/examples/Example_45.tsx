  ...
  return (
    <div className="space-y-8 p-6">
      ...
      <div className="space-y-4 rounded-lg bg-white p-6 shadow-lg">
        <h2 className="text-xl font-semibold text-gray-800">Customize Hologram Separator</h2>
        ...
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-gray-600">
              The Hologram Separator creates a futuristic division with a semi-transparent, 
              holographic effect that seems to float above the surface.
            </p>
          </div>
          <HologramSeparator
          ...
          <div className="flex-1">
            <p className="text-gray-600">
              Perfect for sci-fi themed designs or any interface where you want 
              to add a touch of high-tech sophistication.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-gray-300">
              Against dark backgrounds, the hologram effect creates an ethereal glow, 
              with light seemingly bending through the transparent barrier.
            </p>
          </div>
          <HologramSeparator
            orientation={orientation}
          ...
          <div className="flex-1">
            <p className="text-gray-300">
              The animated hologram effect creates a sense of advanced technology, 
              bringing your design into the future.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 rounded-lg bg-gradient-to-r from-cyan-900 to-teal-900 p-6">
        <h3 className="text-center text-lg font-medium text-white">Gradient Background Example</h3>
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-white">
              On gradient backgrounds, the Hologram Separator creates a stunning interplay 
              of light and color, with holographic elements refracting the background.
            </p>
          </div>
          <HologramSeparator
            orientation={orientation}
          ...
          <div className="flex-1">
            <p className="text-white">
              The combination of gradient background and hologram effects produces 
              a cutting-edge aesthetic perfect for modern web applications.
            </p>
          </div>
        </div>
      </div>
