  ...
  return (
    <div className="w-full space-y-8 p-4">
      ...
      <div className="space-y-4 rounded-lg bg-gray-100 p-4 dark:bg-gray-800">
        <h2 className="text-lg font-semibold">Customize Morse Code Separator</h2>
      ...
      <div className="space-y-4 rounded-lg bg-white p-6 dark:bg-gray-900">
        <h3 className="text-center text-lg font-medium">Morse Code Separator Example</h3>
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-gray-600 dark:text-gray-300">
              The Morse Code Separator creates a unique visual division using dots and dashes,
              inspired by Morse code patterns. Perfect for tech-themed or communication-focused interfaces.
            </p>
          </div>
          <MorseCodeSeparator
          ...
          <div className="flex-1">
            <p className="text-gray-600 dark:text-gray-300">
              ...
              The dots and dashes animate in sequence, creating an engaging visual pattern.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-gray-300">
              The Morse Code Separator maintains its visual appeal on dark backgrounds,
              with the glowing dots and dashes creating an even more striking effect.
            </p>
          </div>
          <MorseCodeSeparator
            orientation={orientation}
          ...
          <div className="flex-1">
            <p className="text-gray-300">
              The separator&apos;s glow and animation effects become more pronounced against darker backgrounds,
        ...
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-white">
              When placed on gradient backgrounds, the Morse Code Separator adds an additional layer of visual interest,
          ...
          <div className="flex-1">
            <p className="text-white">
              The separator&apos;s dots and dashes create beautiful interactions with gradient backgrounds,
