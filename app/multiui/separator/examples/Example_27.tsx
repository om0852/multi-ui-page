  ...
  return (
    <div className="w-full space-y-8 p-4">
      ...
      <div className="space-y-4 rounded-lg bg-gray-100 p-4 dark:bg-gray-800">
        <h2 className="text-lg font-semibold">Customize Electric Arc Separator</h2>
      ...
      <div className="space-y-4 rounded-lg bg-white p-6 dark:bg-gray-900">
        <h3 className="text-center text-lg font-medium">Electric Arc Separator Example</h3>
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-gray-600 dark:text-gray-300">
              The Electric Arc Separator creates an energetic division with lightning effects.
              Perfect for dynamic and electrifying interface designs.
            </p>
          </div>
          <ElectricArcSeparator
          ...
          <div className="flex-1">
            <p className="text-gray-600 dark:text-gray-300">
              The animated electric arcs create a sense of power and energy,
              ideal for tech-focused or power-themed interfaces.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-gray-300">
              Against dark backgrounds, the Electric Arc Separator creates dramatic
              lightning effects that energize your interface.
            </p>
          </div>
          <ElectricArcSeparator
            orientation={orientation}
          ...
          <div className="flex-1">
            <p className="text-gray-300">
              The electric arcs become more vibrant in dark mode,
              creating an electrifying visual experience.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-white">
              The Electric Arc Separator adds a powerful energy element to gradient backgrounds,
          ...
          <div className="flex-1">
            <p className="text-white">
              The combination of gradient backgrounds and electric arcs creates
              a stunning visual effect that captures attention.
            </p>
          </div>
        </div>
      </div>
