...
import Separator from '../_components/Separator_8';
...
export default function SeparatorExample() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Pulse Ring Separator</h1>
      ...
      <div className="mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <p className="text-gray-700 mb-4">
            This is some content above the separator. The pulse ring separator creates a dynamic, rhythmic division between content sections.
          </p>
          ...
          <p className="text-gray-700 mt-4">
            This is some content below the separator. The pulsing rings create a lively and engaging division between sections.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gray-900 p-6 rounded-lg shadow-sm">
          ...
          <p className="text-gray-300 mb-4">
            The pulse ring effect is even more striking on dark backgrounds.
          </p>
