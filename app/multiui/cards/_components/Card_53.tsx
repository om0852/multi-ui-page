      ...
      {isHovered && (
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background: `
                radial-gradient(circle at 30% 20%, rgba(216, 180, 254, 0.2) 0%, transparent 50%),
                radial-gradient(circle at 70% 60%, rgba(216, 180, 254, 0.2) 0%, transparent 50%),
                radial-gradient(circle at 40% 80%, rgba(216, 180, 254, 0.2) 0%, transparent 50%),
                radial-gradient(circle at 80% 30%, rgba(216, 180, 254, 0.2) 0%, transparent 50%)
              `,
              filter: 'blur(20px)',
            }}
            animate={{
    ...
    return (
      ...
      >
        ...
        <div className="relative p-6">
          ...
          <p className="text-purple-300">Discover the magic</p>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="relative p-6">
        ...
        >
          {[
            { label: 'Magic Power', value: 'Level 99' },
            { label: 'Spells', value: '42/42' },
            { label: 'Wisdom', value: 'Ancient' },
            { label: 'Elements', value: 'All' },
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
