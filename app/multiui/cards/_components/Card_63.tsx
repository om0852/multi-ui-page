      ...
      {isHovered && (
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background: `
                linear-gradient(transparent 0%, rgba(236, 72, 153, 0.2) 2%, transparent 5%),
                linear-gradient(90deg, transparent 0%, rgba(236, 72, 153, 0.2) 2%, transparent 5%)
              `,
    ...
    >
      ...
      <div className="relative p-6">
        ...
        >
          ...
          >
            <div className="w-full h-full rounded-lg bg-gradient-to-br from-pink-500 to-pink-600 flex items-center justify-center p-4">
        ...
        >
          {[
            ...
            >
              <div className="text-pink-400 text-sm font-mono">{stat.label}</div>
        ...
        >
          ...
          <motion.button
            className="px-6 py-2 rounded-lg border-2 border-pink-600 text-pink-400 font-medium font-mono"
            whileHover={{
              scale: 1.05,
