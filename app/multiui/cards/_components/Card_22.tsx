...
const SocialLinks: React.FC<{ isHovered: boolean }> = ({ isHovered }) => {
  const socialLinks = [
  ...
  return (
    ...
    >
      ...
      <div className="relative p-6 text-center">
        ...
        >
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 animate-spin-slow" style={{ animationDuration: '3s' }} />
          <motion.img
            src="/team-member.jpg"
            alt="Team Member"
        ...
        <motion.p
          ...
          transition={{ duration: 0.3 }}
        >
          Passionate about creating intuitive user experiences and building products that make a difference.
        </motion.p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
        >
          <SocialLinks isHovered={isHovered} />
        </motion.div>
      </div>
