...
export const Example = () => {
  ...
  return (
    <div className="p-8 bg-gradient-to-r from-black via-gray-900 to-black min-h-screen flex items-center justify-center">
      <div className="p-6 rounded-xl bg-black shadow-lg border-2 border-green-500">
        <h1 className="text-2xl font-bold text-green-300 mb-4">Enter OTP</h1>
        <InputOTP
          maxLength={6}
