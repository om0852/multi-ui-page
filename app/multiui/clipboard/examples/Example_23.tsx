...
import Clipboard from '../_components/Clipboard_23';
...
const Example_23: React.FC = () => {
  ...
  const clipboardExamples = [
    {
      text: "Flat design",
      onCopy: () => console.log("Flat design copied!")
    },
    {
      text: "Accent line",
      onCopy: () => console.log("Accent line copied!")
    },
    {
      text: "Minimal style",
      onCopy: () => console.log("Minimal style copied!")
    },
    {
      text: "Clean look",
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Modern clipboard with flat design and smooth accent line animations.
          </p>
        </div>
