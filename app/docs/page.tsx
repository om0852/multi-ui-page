...
const DocsPage = () => {
  ...
  const sections = [
    ...
    { id: 'installation', title: 'Installation', icon: <Package className="w-4 h-4" /> },
    { id: 'project-setup', title: 'Project Setup', icon: <Terminal className="w-4 h-4" /> },
    { id: 'add-components', title: 'Add Components', icon: <Puzzle className="w-4 h-4" /> },
    { id: 'additional-commands', title: 'Additional Commands', icon: <Code2 className="w-4 h-4" /> },
    { id: 'project-structure', title: 'Project Structure', icon: <Boxes className="w-4 h-4" /> },
    { id: 'configuration', title: 'Configuration', icon: <Wrench className="w-4 h-4" /> },
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 overflow-hidden">
      ...
      <div className="lg:grid lg:grid-cols-[280px,1fr] relative">
        ...
        {/* Installation Section */}
          <div id="installation" className="scroll-mt-20 mb-12 sm:mb-20">
            <motion.div 
              ...
              animate="visible"
            >
              <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center">Installation</h2>
              <div className="space-y-6 sm:space-y-8">
                <motion.div 
                  className="bg-gray-800/70 rounded-lg sm:rounded-xl p-4 sm:p-6 backdrop-blur-sm border border-gray-700/70 relative overflow-hidden"
                  variants={itemVariants}
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                    <div className="flex-1 w-full">
                      <p className="text-sm sm:text-base text-gray-300 mb-4">Install the Multi UI CLI tool using your preferred package manager:</p>
                      <PackageManagerTabs commands={installCommands} />
                    </div>
                  </div>
                </motion.div>
        ...
        {/* Project Setup Section */}
          <div id="project-setup" className="scroll-mt-20 mb-12 sm:mb-20">
            <motion.div 
              ...
              animate="visible"
            >
              <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center">Project Setup</h2>
              <div className="space-y-6 sm:space-y-8">
                <motion.div 
                  className="bg-gray-800/70 rounded-lg sm:rounded-xl p-4 sm:p-6 backdrop-blur-sm border border-gray-700/70 relative overflow-hidden"
                  variants={itemVariants}
        ...
        <motion.div 
          ...
          animate="visible"
        >
              <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center">Add Components</h2>
