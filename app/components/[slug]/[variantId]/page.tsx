...
export default function VariantPage({ 
  ...
  params: VariantPageParams | Promise<VariantPageParams> 
}) {
  // Unwrap the params Promise using React.use()
  const unwrappedParams = React.use(params as any) as VariantPageParams;
  const { slug, variantId } = unwrappedParams;
  ...
  useEffect(() => {
    const fetchComponentCode = async () => {
      try {
        // In a real implementation, you would fetch these from your backend or file system
        // For demo purposes, we're just providing example code
