...
import Avatar from '../_components/Avatar_28';

export default function AvatarExample28() {
  const avatarImages = [
  ...
  return (
    <div className="p-4 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      <h2 className="text-2xl font-bold text-white mb-6">Neon Rings Avatar</h2>
      ...
      <div className="flex flex-col space-y-8 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col space-y-4">
          <h3 className="text-xl font-semibold text-white text-center">Rotating Neon Rings Animation</h3>
          ...
          <p className="text-white text-center mt-4">
            The avatar is surrounded by multiple rotating neon gradient rings, creating a cyberpunk effect, and scales slightly on hover
          </p>
        </div>
      </div>
    </div>
