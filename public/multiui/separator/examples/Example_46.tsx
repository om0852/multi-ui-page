  ...
  return (
    <div className="w-full space-y-8 p-4">
      ...
      <div className="space-y-4 rounded-lg bg-gray-100 p-4 dark:bg-gray-800">
        <h2 className="text-lg font-semibold">Customize Quantum Tunnel Separator</h2>
      ...
      <div className="space-y-4 rounded-lg bg-white p-6 dark:bg-gray-900">
        <h3 className="text-center text-lg font-medium">Quantum Tunnel Separator Example</h3>
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-gray-600 dark:text-gray-300">
              The Quantum Tunnel Separator creates a futuristic visual division with animated tunnel rings and particles,
              perfect for sci-fi themed interfaces.
            </p>
          </div>
          <QuantumTunnelSeparator
        ...
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-gray-300">
              The Quantum Tunnel Separator maintains its visual appeal on dark backgrounds,
      ...
      <div className="space-y-4 rounded-lg bg-gradient-to-r from-blue-500 to-green-500 p-6">
        <h3 className="text-center text-lg font-medium text-white">Gradient Background Example</h3>
        <div className={orientation === "horizontal" ? "space-y-4" : "flex gap-4"}>
          <div className="flex-1">
            <p className="text-white">
              When placed on gradient backgrounds, the Quantum Tunnel Separator adds an additional layer of visual interest,
...
export default SeparatorExample46; 