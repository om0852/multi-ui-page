...
import Separator from '../_components/Separator_7';
...
export default function SeparatorExample() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Double Line Separator</h1>
      ...
      <div className="mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <p className="text-gray-700 mb-4">
            This is some content above the separator. The double line separator creates an elegant division between content sections.
          </p>
          ...
          <p className="text-gray-700 mt-4">
            This is some content below the separator. The double line design adds a sophisticated touch to your layout.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gray-900 p-6 rounded-lg shadow-sm">
          ...
          <p className="text-gray-300 mb-4">
            The double line separator stands out beautifully on dark backgrounds.
          </p>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg shadow-sm">
          <h3 className="text-xl font-semibold text-indigo-900 mb-4">Gradient Background</h3>
          <p className="text-indigo-700 mb-4">
            The separator works well on subtle gradient backgrounds too.
          </p>
