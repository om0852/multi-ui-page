...
import InputField from '../_components/InputField_43';
    ...
    <div style={{
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          Experience the fluid animations as you interact with the fields
        </p>
      </div>
      ...
      <div style={{
        ...
        Click on any input field to see the liquid fill animation in action!
      </div>
    </div>
  );
};
