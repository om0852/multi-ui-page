...
export default function BadgeExample3() {
  return (
    <div className="p-2 sm:p-4 md:p-6 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-4 sm:mb-6 md:mb-8">Bounce On Click Badge</h2>
      ...
      <div className="flex flex-col space-y-4 sm:space-y-6 md:space-y-8 max-w-sm sm:max-w-xl md:max-w-2xl mx-auto">
        ...
        {/* Click instructions */}
        <div className="flex flex-col space-y-2 sm:space-y-3 md:space-y-4">
          <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-white text-center">Click Interaction Demonstration</h3>
        ...
        <div className="flex flex-col space-y-2 sm:space-y-3 md:space-y-4">
          ...
          <div className="bg-gray-800 p-3 sm:p-4 md:p-6 rounded-lg">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-300">Interactive elements that provide visual feedback when clicked</p>
          </div>
        </div>
      </div>
    </div>
