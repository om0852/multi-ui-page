...
export const HorizontalRadioGroupSpinFadePulse: React.FC<RadioGroupProps> = ({
  options,
  name,
  selectedValue,
  onChange,
          ...
          <motion.div
            ...
            animate={{
              ...(index === 0 && selectedValue === option.value
                ? { rotate: [0, 360] } // Spin Effect
                : {}),
              ...(index === 1 && selectedValue === option.value
                ? { opacity: [1, 0.5, 1] } // Fade Effect
                : {}),
...
const App: React.FC = () => {
  ...
  return (
    <div className="p-6">
      ...
      <HorizontalRadioGroupSpinFadePulse
        options={options}
        name="spinFadePulseExample"
