...
export default function Share_29({ url, className = "" }: ShareProps) {
    ...
    >
      ...
      {platforms.map((platform, index) => (
        <motion.button
          ...
          className={`p-2 rounded-full ${platform.color} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors`}
        >
...
export function Component() {
  return (
    <div className="p-4">
      <Share_29 url="https://example.com/share-this" />
    </div>
  );
} 