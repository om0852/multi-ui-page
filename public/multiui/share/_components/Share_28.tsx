...
export default function Share_28({ url, className = "" }: ShareProps) {
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-px flex-1 w-12 bg-gray-200 dark:bg-gray-700" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {platforms.map((platform, index) => (
            <motion.button
              ...
              className={`flex items-center gap-3 p-3 rounded-xl ${platform.color} ${platform.hoverColor} transition-colors`}
            >
        ...
        <div className="mt-6">
          <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={handleCopy}
              className="px-3 py-1 text-sm font-medium text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-600 rounded-lg shadow-sm"
            >
              {copied ? "Copied!" : "Copy"}
            </motion.button>
          </div>
...
export function Component() {
  return (
    <div className="p-4">
      <Share_28 url="https://example.com/share-this" />
    </div>
  );
} 