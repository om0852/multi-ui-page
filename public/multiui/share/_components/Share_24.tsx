...
export default function Share_24({ url, className = "" }: ShareProps) {
        ...
        <div className="grid grid-cols-2 gap-4">
          {platforms.map((platform, index) => (
            <motion.button
              ...
              className={`flex items-center justify-center gap-3 px-4 py-3 rounded-2xl border backdrop-blur-sm ${platform.color} border-white/20 dark:border-white/10 hover:bg-white/10 dark:hover:bg-white/5 transition-colors`}
            >
...
export function Component() {
  return (
    <div className="p-8 min-h-[400px] bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-gray-900 dark:to-gray-800">
      <Share_24 url="https://example.com/share-this" />
    </div>
  );
} 