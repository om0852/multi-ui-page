...
import Clipboard from '../_components/Clipboard_51';
  ...
  const clipboardExamples = [
    {
      ...
      onCopy: () => console.log("Command copied!")
    },
    {
      text: "cd /usr/local/bin",
      onCopy: () => console.log("Directory command copied!")
    },
    {
      text: "sudo apt-get update",
      onCopy: () => console.log("Update command copied!")
    },
    {
      text: "grep -r 'pattern' .",
      onCopy: () => console.log("Search command copied!")
    }
  ];
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            Retro Terminal Clipboard
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Old-school terminal clipboard with scanline effects and green text glow.
          </p>
        </div>
        ...
        {/* Features List */}
        <div className="mt-12 p-6 bg-black rounded-lg border border-green-500/20">
