...
import Clipboard from '../_components/Clipboard_25';
...
const Example_25: React.FC = () => {
  ...
  const clipboardExamples = [
    {
      text: "Monochrome style",
      onCopy: () => console.log("Monochrome style copied!")
    },
    {
    ...
    {
      text: "Subtle hover",
      onCopy: () => console.log("Subtle hover copied!")
    }
  ];
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            Monochromatic Clipboard
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Clean clipboard with elevation shadows and subtle hover effects.
          </p>
        </div>
