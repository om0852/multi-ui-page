...
import Clipboard from '../_components/Clipboard_24';
  ...
  const clipboardExamples = [
    {
      ...
      onCopy: () => console.log("Gradient border copied!")
    },
    {
      text: "Animated glow",
      onCopy: () => console.log("Animated glow copied!")
    },
    {
    ...
    {
      text: "Modern style",
      onCopy: () => console.log("Modern style copied!")
    }
  ];
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            Gradient Border Clipboard
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Modern clipboard with animated gradient borders and smooth transitions.
          </p>
        </div>
