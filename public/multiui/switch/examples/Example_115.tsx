...
import Switch from "../_components/Switch_115";

const SwitchExample115 = () => {
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
            ...
            <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <p>• {guidedMeditation ? "Guided meditation on" : "Silent mode"}</p>
              <p>• {backgroundSounds ? "Background sounds on" : "Silent mode"}</p>
              <p>• {meditationReminders ? "Reminders on" : "No reminders"}</p>
...
export default SwitchExample115; 