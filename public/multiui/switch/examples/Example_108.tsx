...
import Switch from "../_components/Switch_108";

const SwitchExample108 = () => {
      ...
      <div className="rounded-lg bg-white p-6 dark:bg-gray-900">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
            ...
            {taskReminders && (
              <div className="mt-4 text-sm text-purple-600 dark:text-purple-400">
                • Receive timely task notifications
              </div>
            )}
          </div>
          ...
          <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
            ...
            {progressAnalytics && (
              <div className="mt-4 text-sm text-purple-600 dark:text-purple-400">
                • Track productivity metrics and trends
              </div>
            )}
          </div>
...
export default SwitchExample108; 