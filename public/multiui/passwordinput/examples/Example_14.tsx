...
import { PasswordInput } from '../_components/PasswordInput_14';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <PasswordInput
              ...
              isValid={!formSubmitted || !validatePassword(password)}
              error={formSubmitted ? validatePassword(password) || undefined : undefined}
            />
          </div>
