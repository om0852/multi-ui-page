...
const Toast_10: React.FC<ToastProps> = ({
  message,
  close,
  ...
  return (
    <motion.div
      ...
      className={clsx(
        " flex items-center p-4 minw-[200px] max-w-[350px] w-full bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 rounded-2xl shadow-2xl z-50",
