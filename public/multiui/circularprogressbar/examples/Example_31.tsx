...
import CircularProgressBar from '../_components/CircularProgressBar_31';
...
const Example_31 = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-cyan-950 to-cyan-900">
      <h1 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-cyan-100">
        Wave Progress Ring
      </h1>
      ...
      <div className="mt-8 bg-black/20 backdrop-blur-lg p-6 rounded-xl shadow-2xl w-full max-w-md border border-cyan-500/20">
        <h2 className="text-lg font-semibold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-cyan-100">
          Wave Features
        </h2>
        <ul className="list-disc pl-5 space-y-2 text-cyan-300">
          <li>Animated wave displacement effect</li>
          <li>Expanding ripple animation</li>
          <li>Floating percentage display</li>
          <li>Turbulence filter animation</li>
