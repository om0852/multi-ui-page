...
const Button: React.FC<ButtonProps> = ({
  ...
  // Base style for the liquid wave effect with turquoise-to-teal gradient
  const liquidBaseStyles = filled
    ? 'bg-gradient-to-r from-teal-400 to-turquoise-500 text-white'
    : 'bg-transparent border-2 border-gradient-to-r from-teal-400 to-turquoise-500 text-teal-400';
      ...
      >
        ...
        >
          <motion.span
            ...
            className="absolute inset-0 bg-gradient-to-r from-teal-400 to-turquoise-500"
            style={{
              zIndex: -1,
