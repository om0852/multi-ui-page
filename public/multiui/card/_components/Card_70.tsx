    ...
    return (
      ...
      >
        ...
        <div className="relative p-6">
          <h3 className="text-xl font-bold text-white">SYNTHWAVE</h3>
          <p className="text-pink-500">Back to the 80s</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative p-6">
        ...
        >
          {[
            ...
            >
              <div className="text-pink-500 text-sm">{stat.label}</div>
        ...
        >
          ...
          <motion.button
            className="px-6 py-2 rounded-lg border-2 border-pink-600 text-pink-500 font-medium"
            whileHover={{
              scale: 1.05,
