    ...
    return (
      ...
      >
        ...
        <div className="relative p-6">
          ...
          <p className="text-pink-300">Back to the 80s</p>
        </div>
      </div>
    );
  }
    ...
    >
      ...
      <div className="relative p-6">
        ...
        >
          ...
          >
            <div className="w-full h-full rounded-full bg-gradient-to-br from-pink-400 to-pink-600 flex items-center justify-center p-4">
