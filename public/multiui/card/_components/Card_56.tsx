    ...
    return (
      ...
      >
        ...
        <div className="relative p-6">
          <h3 className="text-xl font-bold text-emerald-800">Natural Flow</h3>
          <p className="text-emerald-600">Embrace growth</p>
        </div>
      </div>
    );
  }
        ...
        >
          {[
            ...
            >
              ...
              <div className="text-emerald-900 font-bold">{stat.value}</div>
            </motion.div>
          ))}
        </motion.div>
