        ...
        >
          ...
          {[...Array(3)].map((_, i) => (
            <motion.div
              ...
              style={{
                background: `linear-gradient(180deg, transparent, rgba(56, 189, 248, ${0.1 - i * 0.02}))`,
      ...
      <div className="relative p-6">
        ...
        >
          {[
            ...
            { label: 'Waves', value: 'Dynamic' },
            { label: 'Ripples', value: 'Active' },
            { label: 'Current', value: 'Strong' },
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
